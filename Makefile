#############################################################################
# Makefile for building: adi
# Generated by qmake (3.1) (Qt 5.15.1)
# Project:  adi.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile adi.pro -spec linux-g++ CONFIG+=qtquickcompiler
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = adi1.0.0
DISTDIR = /run/media/avouch/Avouch/avouch/avh02/projects/adi/.tmp/adi1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
SOURCES       = src/main.cpp \
		src/AvouchInstaller.cpp qrc_adi.cpp \
		moc_AvouchInstaller.cpp
OBJECTS       = main.o \
		AvouchInstaller.o \
		qrc_adi.o \
		moc_AvouchInstaller.o
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/usr/lib/qt/mkspecs/modules/qt_KDb3.pri \
		...
		/usr/lib/qt/mkspecs/modules/qt_KReport3.pri \
		...
		/usr/lib/qt/mkspecs/modules/qt_MediaWiki.pri \
		...
		adi.pro include/AvouchInstaller.h src/main.cpp \
		src/AvouchInstaller.cpp
QMAKE_TARGET  = adi
DESTDIR       = 
TARGET        = adi
...
Makefile: adi.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		adi.pro \
		resource/adi.qrc
	$(QMAKE) -o Makefile adi.pro -spec linux-g++ CONFIG+=qtquickcompiler
...
distdir: FORCE
	...
	$(COPY_FILE) --parents resource/adi.qrc $(DISTDIR)/
	$(COPY_FILE) --parents /usr/lib/qt/mkspecs/features/data/dummy.cpp $(DISTDIR)/
	$(COPY_FILE) --parents include/AvouchInstaller.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/AvouchInstaller.cpp $(DISTDIR)/
...
compiler_rcc_make_all: qrc_adi.cpp
compiler_rcc_clean:
	-$(DEL_FILE) qrc_adi.cpp
qrc_adi.cpp: resource/adi.qrc \
		/usr/bin/rcc \
		resource/images/2.png \
		resource/images/WatermarkPixmapEula.png \
		resource/images/WatermarkPixmapPartitionSetup.png \
		resource/images/WatermarkPixmapUserSetup.png \
		resource/images/1.png \
		resource/images/WatermarkPixmapDiskSetup.png \
		resource/images/WatermarkPixmapCompleted.png \
		resource/images/welcome.png \
		resource/images/4.png \
		resource/images/WatermarkPixmapWelcome.png \
		resource/images/WatermarkPixmapCopyingFiles.png \
		resource/images/3.png \
		resource/qss/default.qss
	/usr/bin/rcc -name adi resource/adi.qrc -o qrc_adi.cpp
...
compiler_moc_header_make_all: moc_AvouchInstaller.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AvouchInstaller.cpp
moc_AvouchInstaller.cpp: include/AvouchInstaller.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /run/media/avouch/Avouch/avouch/avh02/projects/adi/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/run/media/avouch/Avouch/avouch/avh02/projects/adi -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/10 -I/usr/include/c++/10/x86_64-pc-linux-gnu -I/usr/include/c++/10/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/10/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/10/include-fixed -I/usr/include include/AvouchInstaller.h -o moc_AvouchInstaller.cpp
...
main.o: src/main.cpp include/AvouchInstaller.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o src/main.cpp

AvouchInstaller.o: src/AvouchInstaller.cpp include/AvouchInstaller.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AvouchInstaller.o src/AvouchInstaller.cpp

qrc_adi.o: qrc_adi.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o qrc_adi.o qrc_adi.cpp

moc_AvouchInstaller.o: moc_AvouchInstaller.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_AvouchInstaller.o moc_AvouchInstaller.cpp
